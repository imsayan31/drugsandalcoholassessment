...
$(".next").click(function(){
    ...
    /* Get variables value */
    var assessment_due_date = $('#assessment_due_date').val();
    var assessment_type_confrm = $('.assessment_type_confrm').is(':checked');
    var assessment_online_confrm = $('.assessment_online_confrm').is(':checked');
    ...
    /* Header title change */
    if(_this_id == 'initialNext'){
        //console.log('I am initial state.');
        $('#userRegistrationModal').find('h4.modal-title').text('Verify Location');
    } else if(_this_id == 'firstNext' && user_location > 0){
        $('#userRegistrationModal').find('h4.modal-title').text('Location Verified');
    } else if(_this_id == 'secondNext'){
        $('#userRegistrationModal').find('h4.modal-title').text('About Yourself');
    }
    ...
    } else if(_this_id == 'thirdNext' && user_first_name && user_last_name){
        ...
        if(_this_id == 'fourthNext'){
            ...
            $.post(Registration.ajaxurl, data, function(resp){
                if(resp.flag == true) {
                    ...
                    setTimeout(function(){
                        $('#userAssessmentModal').find('h4.modal-title').text('Pick an Assessment');
                    },3000);
