...
<!-- Choose Assesment Type -->
    ...
    <h3 class="fs-subtitle"><span>Step 1: </span><?php _e('Choose the type you need',THEME_TEXTDOMAIN); ?></h3>
                ...
                foreach ($getProducts as $eachProduct) {
                    ...
                    <li class="<?php echo $liClass; ?>">
                        <label class="control control--radio" for="<?php echo base64_encode($eachProduct->ID); ?>">
                            ...
                            <div class="choose_left"><h3><?php echo $eachProduct->post_title; ?></h3></div>
