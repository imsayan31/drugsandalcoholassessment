...
?>
<style type="text/css">
    .password-validation-instruct li{
        list-style:disc;
        text-align:left;
    }
</style>
                        ...
                        <div class="col-md-10">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <!--    <li>Password should have minimum of 8 characters.</li>-->
                                    <!--    <li>Password must contains one Upper case letter and a special character.</li>-->
                                    <!--</ul>-->
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
