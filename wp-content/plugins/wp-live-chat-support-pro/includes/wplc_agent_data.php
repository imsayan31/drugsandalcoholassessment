...
add_action( 'edit_user_profile', 'wplc_user_profile_fields' );
add_action( 'show_user_profile', 'wplc_user_profile_fields' );
function wplc_user_profile_fields( $user ){
    $ret = "";
...
add_action('edit_user_profile_update', 'wplc_save_user_profile_data'); 
add_action('personal_options_update', 'wplc_save_user_profile_data');
function wplc_save_user_profile_data( $user_id ){
...
add_filter("wplc_filter_further_live_chat_box_above_main_div","wplc_pro_filter_control_live_chat_box_above_main_div",10,5);
function wplc_pro_filter_control_live_chat_box_above_main_div( $msg, $wplc_settings, $cid, $chat_data, $agent ) {
...
add_filter( "wplc_filter_agent_data_social_links", "wplc_pro_filter_control_agent_data_social_links", 10, 7 );
function wplc_pro_filter_control_agent_data_social_links(  $social_links, $cid, $chat_data, $agent, $wplc_acbc_data, $user_info, $data ) {
...
add_filter( "wplc_filter_agent_data_agent_bio", "wplc_pro_filter_control_agent_data_agent_bio", 10, 7 );
function wplc_pro_filter_control_agent_data_agent_bio(  $agent_bio, $cid, $chat_data, $agent, $wplc_acbc_data, $user_info, $data ) {
    if( !isset( $data ) ){ $data = false; }
...
add_filter( "wplc_filter_agent_data_agent_tagline", "wplc_pro_filter_control_agent_data_agent_tagline", 10, 7 );
function wplc_pro_filter_control_agent_data_agent_tagline(  $agent_tagline, $cid, $chat_data, $agent, $wplc_acbc_data, $user_info, $data ) {
    if( !isset( $data ) ){ $data = false; }
...
add_filter( "wplc_filter_simple_agent_data_agent_bio", "wplc_pro_filter_simple_control_agent_data_agent_bio", 10, 2 );
function wplc_pro_filter_simple_control_agent_data_agent_bio(  $agent_bio, $agent_id ) {
    if( !isset( $data ) ){ $data = false; }
...
add_filter( "wplc_filter_simple_agent_data_agent_tagline", "wplc_pro_filter_simple_control_agent_data_agent_tagline", 10, 2 );
function wplc_pro_filter_simple_control_agent_data_agent_tagline(  $agent_tagline, $agent_id ) {
    if( !isset( $data ) ){ $data = false; }
...
add_filter( "wplc_filter_simple_agent_data_social_links", "wplc_pro_filter_simple_control_agent_data_social_links", 10, 2 );
function wplc_pro_filter_simple_control_agent_data_social_links(  $social_links, $agent_id ) {
